...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('asset-sherly/css/style.css') }}">
...
<div class="main">
	<div class="left">
		...
		<div class="box-1">
			...
			<p class="p1"><i class="material-icons icons1">call</i>+62 815-2870-5817</p>
			<p class="p1"><i class="material-icons icons1">email</i>sherlysinti34@gmail.com</p>
		</div>
