...
<html lang="en-US">
  <head>
    ...
    <link href="{{ asset('assetaryo/css/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('assetaryo/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assetaryo/css/main.css') }}" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Anyo.</a>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="{{ asset('assetaryo/images/pfp.jpeg') }}" alt="Image"/></a></div>
          <div class="h2 title">Aryo Syawalito Bimo</div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">aryosyawal.bimo@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+62 851-5644-0441</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Jawa</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">Bahasa, English</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">PHP/LARAVEL</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Team Building</span>
              <div class="progress">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="{{ asset('assetaryo/images/Login.png') }}" alt="Image"/>
                    <figcaption>
                      <div class="h4">Login & Signup Project</div>
                      <p>Web Development</p>
                    </figcaption>
                  </figure></a></div>
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="{{ asset('assetaryo/images/Register.png') }}" alt="Image"/>
                    <figcaption>
                      <div class="h4">Imitation Project</div>
                      <p>Web Development</p>
                    </figcaption>
                  </figure></a></div>
            </div>
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="{{ asset('assetaryo/images/landingpage.png') }}" alt="Image"/>
                    <figcaption>
                      <div class="h4">Hospital Landingpage Project</div>
                      <p>Web Development</p>
                    </figcaption>
                  </figure></a></div>
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="{{ asset('assetaryo/images/dashboard.png') }}" alt="Image"/>
                    <figcaption>
                      <div class="h4">Hospital Dashboard Project</div>
                      <p>Web Development</p>
                    </figcaption>
                  </figure></a></div>
            </div>
  ...
  <div class="container cc-experience">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Admin Dashboard Project</p>
            <div class="h5">PHP</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Back-End Developer</div>
            <p>Made a working dashboard with a CRUD system using native PHP</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Game Making Experience</p>
            <div class="h5">Javascript</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Game Developing</div>
            <p>Made a working flappybird type-game using Javascript</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p>Made a whole responsive landingpage with an amazing design</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2012 - 2018</p>
            <div class="h5">Elementary Grad</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Kalibaru 03</div>
            <p class="category">Elementary School</p>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2018-2021</p>
            <div class="h5">Middle School Grad</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2021-2022</p>
            <div class="h5">Current Student at Taruna Bhakti Vocational HS</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
...
<div class="section" id="team">
  <div class="container cc-reference">
      ...
      <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assetaryo/images/Dipadan.jpeg') }}" alt="Image"/>
                <div class="h5 pt-2">Divadan Arya</div>
                <p class="category">Back-End Developer</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p>A multi-talented developer with a lot of knowledge</p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assetaryo/images/Ibe.jpeg') }}" alt="Image"/>
                <div class="h5 pt-2">Ibrahim Khalis</div>
                <p class="category">Front-End Developer</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p>A briliant front-end developer with many amazing designs and ideas</p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="row">
              <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assetaryo/images/Andy.jpeg') }}" alt="Image"/>
                <div class="h5 pt-2">Andy Alphard</div>
                <p class="category">Front-End Developer</p>
              </div>
              <div class="col-lg-10 col-md-9">
                <p>A reliable front-end developer with problem solving abilities</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="{{ asset('assetaryo/js/core/popper.min.js') }}"></script>
    <script src="{{ asset('assetaryo/js/core/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assetaryo/js/aos.js') }}"></script>
    <script src="{{ asset('assetaryo/js/now-ui-kit.js') }}"></script>
    <script src="{{ asset('assetaryo/scripts/main.js') }}"></script>
  </body>
</html>
