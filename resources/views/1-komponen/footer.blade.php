		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
                ...
                <ul class="social-icon">
                    ...
                    <li><a href="https://www.instagram.com/xi_pplg2/" target="blank_" class="fa fa-instagram wow fadeInUp" data-wow-delay="0.8s"></a></li>
                    <li><a href="#" class="fa fa-google-plus wow fadeInUp" data-wow-delay="1.0s"></a></li>
                </ul>

				<p class="wow fadeInUp"  data-wow-delay="1s" >Copyright &copy; 2022 PPLG Company |
